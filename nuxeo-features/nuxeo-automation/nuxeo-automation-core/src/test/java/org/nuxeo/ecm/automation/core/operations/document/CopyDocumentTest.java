...
public class CopyDocumentTest {
    ...
    public void testLifeCycleResetOnCopy() throws OperationException {
        ...
        // Call Document.Copy without reseting the lifecycle state of the copy
        Map<String, Serializable> params = new HashMap<>();
        params.put(TARGET_PROPERTY_KEY, COPY_PATH);
        params.put(NAME_PROPERTY_KEY, COPY_DOC_NAME);
        params.put(CoreEventConstants.RESET_LIFECYCLE, Boolean.FALSE);
        ...
        params.put(TARGET_PROPERTY_KEY, COPY_PATH);
        params.put(NAME_PROPERTY_KEY, COPY_DOC_NAME);
        params.put(CoreEventConstants.RESET_LIFECYCLE, Boolean.TRUE);
