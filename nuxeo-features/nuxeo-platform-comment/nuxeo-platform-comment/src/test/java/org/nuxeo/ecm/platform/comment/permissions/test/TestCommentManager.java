...
public class TestCommentManager {
    ...
    public void testCreateReadDelete() throws Exception {
        CommentManager commentManager = new CommentManagerImpl(CommentServiceHelper.getCommentService().getConfig());
        // Create a user
        ...
        folder = systemSession.createDocument(folder);
        ...
        try (CloseableCoreSession userSession = coreFeature.openCoreSession(USERNAME)) {
            ...
            assertEquals(COMMENT_CONTENT, comments.get(0).getPropertyValue(COMMENT_CONTENT_PROPERTY_XPATH));
